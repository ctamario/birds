---
title: "Animera fågelobservationer"
---

## Uppträdande av tre sibbar i Norge och Sverige

Data inkluderar alla observationer av sibirisk piplärka, tajgasångare och kungsfågelsångare från och med 1990 till och med 2022 i Norge och Sverige. Alla observationer sammanslagna till "ett år" som visar de tidsrumsliga uppträdandena av respektive art. 

En blå punkt dyker upp på första dagen av en observation och vilken gradvis tonas ned i intensitet över fem dagar. Storleken på punkten är logaritmiskt proportionell till hur många individer som observerades (skillnaden i storlek mellan 1 och 2 individer är större än 20 och 21 individer). 

Den röda punkten är medianen av alla observationer under en viss dag; dock har ett "rullande medelvärde" har applicerats där den röda medianpunktens position beaktar de senaste fem dagarnas värde. Den röda linjen visar hur medianen har rört sig under säsongen. Färgstyrkan på linjen är proportionell till hur många observationer vid som har genererat linjen en viss tidpunkt.

Något som bör beaktas i tolkningen av den röda linjen är att den nödvändigtvis inte reflekterar migrationsriktning. Om kallfronten från norr pressar ned fönstret under hösten kommer "median"-observationen att förflyttas söderut, även om det teoretiska inflödet är från (nord/rakt/syd)-ostlig sektor. 
...
Detta är ett arbetsflöde som endast gäller för svensk (https://www.artportalen.se/) och norsk (https://www.artsobservasjoner.no/) data. 
...
Optimalt bör ett API användas för att hämta data direkt från portalerna med reproducerbar kod, men för tillfället har den manuella exporten från databasernas "Sök"-funktion använts: Exportera data till Excel, ta därefter bort de första två raderna som innehåller exportparametrarna och spara om till .csv. 
